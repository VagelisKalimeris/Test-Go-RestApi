...
# from go_rest_tests.conftest import valid_post, valid_user, valid_user_id, valid_post_id
# from go_rest_tests.test_data.models import UserStatus
#
#
# @pytest.mark.parametrize(['resource_path', 'resource_data', 'resource_id', 'update_info'], [
#     ('users', valid_user, valid_user_id, {'status': UserStatus.inactive.value}),
#     ('posts', valid_post, valid_post_id, {'title': 'Summer vacation cancelled!'})
# ])
# class TestAllResourcesCRUD:
#     """
#     Resource creation and deletion are tested by global fixtures.
#
